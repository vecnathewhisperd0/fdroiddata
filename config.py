...
# in text files!
keystorepass = "LzKGatkeVHpG/MMnnU4MMtpfFB+RL8uB/dX6HrnP2p0="
...
keypass = "LzKGatkeVHpG/MMnnU4MMtpfFB+RL8uB/dX6HrnP2p0="

# The distinguished name used for all keys.
keydname = "CN=mincentro, OU=F-Droid"
